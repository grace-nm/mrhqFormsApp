...
router.post('/selfReflectionLevelFour', (req, res)=>{
    ...
    const sql = "INSERT INTO selfReflectionLevelFour VALUES ?";
    const values =[[null, fname, responsible, experience, learn, well, challenge, improve]];
    console.log(values);
