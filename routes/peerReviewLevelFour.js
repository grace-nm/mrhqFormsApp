...
router.post('/peerReviewLevelFour', (req, res)=>{
    console.log('Trying to submit mid course feedback form')
    ...
    const allowExpress = req.body.express;
    const comments = req.body.comments;

    // console.log(fname + ' ' + email + ' ' + quali + ' ' + gender + ' ' + city + ' ' + dob);
    const sql = "INSERT INTO peerReviewLevelFour VALUES ?";
